/* src/config/powh-config.h.  Generated from powh-config.h.in by configure.  */
/* src/config/powh-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef POWH_CONFIG_H

#define POWH_CONFIG_H
...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The PoWH Core developers"
...
#define PACKAGE_BUGREPORT "https://github.com/RavenProject/PoWH/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Raven Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Raven Core 4.6.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "powh"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://powhcoin.org/"
